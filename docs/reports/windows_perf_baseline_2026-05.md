...
| Widget SVG re-rasterization 512x512 | <= 1 ms p99 | Baseline: 4.526 ms cold; 6.869 ms warm. Follow-up local retained path: 2.495 ms cold parse upper estimate; 0.0248 ms warm identical upper estimate; 0.291 ms warm numeric/color parameter-changing upper estimate. TzeHouse retained rerun: 0.332 ms warm identical upper estimate; 4.309 ms warm numeric/color parameter-changing upper estimate; 6.261 ms warm text-changing upper estimate | Pass on TzeHouse only for unchanged-params cache reuse; retained numeric/color and text-changing re-raster paths miss target |
