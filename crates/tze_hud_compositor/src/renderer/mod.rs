...
use image_cache::{apply_composer_slot, composer_display_text};
use token_colors::*;
...
impl Compositor {
    ...
    ///
    /// The returned commands are consumed by [`Compositor::encode_video_frame_pass`]
