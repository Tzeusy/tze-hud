...
//! | `portal.lifecycle.accent_width_px` | lifecycle affordance | width of the left-edge accent bar in px |
...
/// adapter never hardcodes a literal width either (hud-m48i0).
...
pub struct PortalPartTokens {
    ...
    /// *color* comes from the four accents above; this keeps the adapter free of
    /// any literal accent dimension (hud-m48i0).
...
mod tests {
    ...
    // ── §lifecycle accent bar width (hud-m48i0) ──────────────────────────
    ...
    /// the adapter never hardcodes the accent dimension.
    #[test]
