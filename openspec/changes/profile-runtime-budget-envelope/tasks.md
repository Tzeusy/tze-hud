...
- [x] 4.3 Wire image/GPU resource residency, widget raster caches, and font residency to class/aggregate admission at their existing safe eviction boundaries, including no-cache fallbacks where the work is optional.
- [x] 4.4 Add tests proving logical shared-resource double-charging, physical allocation single-charging, separate CPU/GPU copies, and current-frame eviction safety.
