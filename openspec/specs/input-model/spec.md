...
Stylus-specific properties (pressure, tilt, twist) are explicitly deferred post-v1. Pointer events in v1 SHALL carry basic coordinates only; pressure, tilt, and twist fields SHALL NOT be present.
