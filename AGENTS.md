...
- Epic report scaffolding has an in-repo target at `scripts/epic-report-scaffold.sh`; it must normalize both object-root and array-root payloads from `bd show --json`.
