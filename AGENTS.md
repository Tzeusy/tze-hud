...
- Cooperative HUD projection gen-2 reconciliation lives at `docs/reports/cooperative_hud_projection_gen2_reconciliation_20260510.md`; sync is ready, and archive should preserve the accepted evidence substitution that runtime-native readback stands in for unavailable SSH desktop screenshot capture.
