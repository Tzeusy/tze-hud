...
EXEMPT_PATHS=(
    ...
    "crates/tze_hud_protocol/src/session_server/tests.rs"
    "crates/tze_hud_protocol/src/session_server/zone_publish.rs"
    "crates/tze_hud_protocol/src/session_server/handshake.rs"
    "crates/tze_hud_protocol/src/session_server/leases.rs"
